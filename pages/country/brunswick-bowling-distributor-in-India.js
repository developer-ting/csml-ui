...
/** Go Karting Page */
export default function brunswickbowlingdistributorinIndia() {
    return (
        <div>
            <Head>
                <title>Exclusive Brunswick Bowling Distributor in India | CSML Group</title>
                <meta name="description" content="CSML is the leading Brunswick bowling equipment distributor in India, offering high-quality products and expert support for FEC & bowling centres." />
                <meta name="og:title" content="Exclusive Brunswick Bowling Distributor in India | CSML Group" />
                <meta name="og:description" content="CSML is the leading Brunswick bowling equipment distributor in India, offering high-quality products and expert support for FEC & bowling centres." />
                <meta name="keywords" content="Brunswick Bowling Distributor in India, Brunswick Bowling Equipment Cost in India, Brunswick Bowling Pinsetter. Brunswick Bowling Lane, Why Choose CSML as Brunswick Bowling Equipment Distributor, Benefits of Having Bowling Centre at FEC, Game Zone & Amusement Centre."/>
                ...
                <link rel="canonical" href="https://csmlgroup.com/country/brunswick-bowling-distributor-in-India"/>
            </Head>
            <Header />
            <Loader />
            <main className={`${styles.GoKartingPage}`}>
                <InsideBanner
                    bannerTitle="Exclusive Brunswick Bowling Distributor in India"
                ...
                <section className={`${styles.lane_oil} pt_100 pb_60`}>
                    <div className="container">
                        <h2 className="color_black heading_text_40 pb_50 text_center toTop" data-scroll>
                            Brunswick Bowling Equipment Cost in India
                        </h2>
                        <p className="global_text paraTxt_18 color_black_opacity toTop">
                            If you're planning to set up or upgrade a bowling centre, CSML provides premium <b>Brunswick Bowling Equipment in India.</b>
                ...
                <section className="dot_animation_box pt_100 pb_60">
                    <div className="container">
                        <h3 className="color_white heading_text_40 pb_50 text_center toTop">
