...
/** Go Karting Page */
export default function brunswickbowlingdistributorinIndonesia() {
    return (
        <div>
            <Head>
                <title>Exclusive Brunswick Bowling Distributor in Indonesia | CSML Group</title>
                <meta name="description" content="CSML is the leading Brunswick bowling equipment distributor in Indonesia, offering high-quality products and expert support for FEC & bowling centres." />
                <meta name="og:title" content="Exclusive Brunswick Bowling Distributor in Singapore | CSML Group" />
                <meta name="og:description" content="CSML is the leading Brunswick bowling equipment distributor in Indonesia, offering high-quality products and expert support for FEC & bowling centres." />
                <meta name="keywords" content="Brunswick Bowling Distributor in Indonesia, Brunswick Bowling Equipment Cost in Indonesia, Brunswick Bowling Pinsetter. Brunswick Bowling Lane, Why Choose CSML as Brunswick Bowling Equipment Distributor, Benefits of Having Bowling Centre at FEC, Game Zone & Amusement Centre."/>
                ...
                <link rel="canonical" href="https://csmlgroup.com/country/brunswick-bowling-distributor-in-Indonesia"/>
            </Head>
            <Header />
            <Loader />
            <main className={`${styles.GoKartingPage}`}>
                <InsideBanner
                    bannerTitle="Exclusive Brunswick Bowling Distributor in Indonesia"
                ...
                <section className={`${styles.lane_oil} pt_100 pb_60`}>
                    <div className="container">
                        <h2 className="heading_text_40 pb_50 text_center toTop" data-scroll>
                            Brunswick Bowling Equipment Cost in Indonesia
                        </h2>
                        <p className="global_text paraTxt_18 color_black_opacity toTop">If you’re considering setting up or upgrading a bowling centre, CSML offers premium Brunswick Bowling Equipment in Indonesia starting at USD30,000 *onwards per lane. Our comprehensive solutions include high-quality lanes, cutting-edge pinsetters, and modern scoring systems designed to deliver a seamless bowling experience. Alongside expert installation and maintenance, we provide dedicated guidance and training to ensure your bowling centre operates smoothly and efficiently.</p>
                    </div>
                </section>
