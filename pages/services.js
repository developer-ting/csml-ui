...
//	IMAGES	//
import services_banner from "../public/img/services/services_banner.jpg";
import Sec1_img from "../public/img/services/consultancy_img.jpg";
import Tabs_img1 from "../public/img/services/tab_img1.jpg";
import Tabs_img2 from "../public/img/services/tab_img2.jpg";
import Tabs_img3 from "../public/img/services/tab_img3.jpg";
	...
	return (
		<div>
			...
			<main className={`${styles.ServicesPage}`}>
				...
				<section className={`${styles.service_tabsec} ptb_80`}>
					<div className="container">
						...
						<div className="container">
							<TabPanel>
								<div className={`${styles.tabs_bx} `}>
									...
									<div className={`${styles.tabs_info}`}>
										<p className={`${styles.info_title}`}>Planning and Layout Design</p>
										<p className={`${styles.info_desc} text_sm`}>
							...
							<TabPanel>
								<div className={`${styles.tabs_bx} `}>
									...
									<div className={`${styles.tabs_info}`}>
										<p className={`${styles.info_title}`}>Exclusive Distribution</p>
										<p className={`${styles.info_desc} text_sm`}>
