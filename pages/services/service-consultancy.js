									...
									<div className={`${styles.tabs_bx}`}>
										...
										<div className={`${styles.tabs_info}`}>
											...
											<p
												className={`${styles.info_desc} paraTxt_18 font_secondary opacity_one`}
											>
												At CSML, we go beyond providing amusement equipment; we craft
												unforgettable experiences. Our approach is rooted in the thorough
												consideration of your target audience's demographics, age groups,
												spending capacity, and budget range. We take pride in offering a
												selection of amusement equipment that not only drives high revenue
												but also resonates with the interests of your guests.
											</p>
										</div>
									</div>
								</div>
									...
									<div className={`${styles.tabs_bx}`}>
										...
										<div className={`${styles.tabs_info}`}>
											...
											<p
												className={`${styles.info_desc} paraTxt_18 font_secondary opacity_one`}
											>
												With our expertise, we assist you in selecting the ideal blend of
												amusement equipment, catering to high-thrill experiences and
												family-friendly attractions. This guarantees that your entertainment
												center becomes a town favorite, leaving visitors with cherished
												memories.
											</p>
										</div>
									</div>
									...
									<div className={`${styles.tabs_bx}`}>
										...
										<div className={`${styles.tabs_info}`}>
											...
											<p
												className={`${styles.info_desc} paraTxt_18 font_secondary opacity_one`}
											>
												We simplify the entire process of obtaining amusement equipment from
												worldwide suppliers. From overseeing ocean freight to managing
												import clearance, we ensure a seamless journey for the equipment to
												reach your location.
											</p>
										</div>
									</div>
									...
									<div className={`${styles.tabs_bx}`}>
										...
										<div className={`${styles.tabs_info}`}>
											...
											<p
												className={`${styles.info_desc} paraTxt_18 font_secondary opacity_one`}
											>
												Our skilled installers take charge of setting up and thoroughly
												testing the amusement equipment, ensuring flawless operation.
												Furthermore, our comprehensive training program empowers your staff
												with hands-on experience in operating the machines and equips them
												with the essential knowledge to ensure seamless venue operations.
											</p>
										</div>
									</div>
								</div>
									...
									<div className={`${styles.tabs_bx} ${styles.tabs_bx_new} tabs_bx`}>
										...
										<div className={`${styles.tabs_info}`}>
											...
											<p
												className={`${styles.info_desc} paraTxt_18 font_secondary opacity_one`}
											>
												At CSML, our dedication to your success extends beyond just
												consultancy and equipment. With our Pre & Post Operation Support
												services, we ensure that your operations run seamlessly by providing
												the essential resources and guidance you need.
											</p>
											{isShowMore && (
												<div className="pt_20">
