			...
			<div className="container">
				<div className={`${styles.sync_info}`}>
					...
					<p className="paraTxt_18 color_white_opacity l_h_6 text_center">
						...
						profitability while addressing challenges.
					</p>
				</div>
			</div>
				...
				<div className={`${styles.partner_superior_flex}`}>
					<Slider {...settings}>
						{data.data.map((item, ind) => {
							return (
								<div className={`${styles.luminaries_box}`} key={ind}>
									<div className={`${styles.luminaries_content}`}>
										...
										<div className={`${styles.desc_box}`}>
											<div className={`${styles.desc_title}`}>
												<h3 className="text_24 color_white text_600 pb_20">
													{item.attributes.title}
												</h3>
											</div>
											<p className="paraTxt_16 l_h_6 color_white">
						...
						{/* <div className={`${styles.luminaries_box}`}>
							<div className={`${styles.luminaries_content}`}>
								...
								<div className={`${styles.desc_box}`}>
									...
									<p className="paraTxt_16 l_h_6 color_white">
										Revolutionize your bowling center experience with SYNC® Scoring
										Consoles. Available in sleek Black and Titanium, these
										state-of-the-art tablets or keypads seamlessly integrate with the
										Brunswick Cloud, ensuring effortless{" "}
									</p>
								</div>
							</div>
						</div>
						<div className={`${styles.luminaries_box}`}>
							<div className={`${styles.luminaries_content}`}>
								...
								<div className={`${styles.desc_box}`}>
									<div className={`${styles.desc_title}`}>
										<h3 className="text_24 color_white text_600 pb_20">
											Sync® Games <br className="hiiden-xs" />
											Games for all Guests
										</h3>
									</div>
									<p className="paraTxt_16 l_h_6 color_white">
										Introducing SYNC® GAMES, a seamless and exhilarating addition to your
										bowling experience. These user-friendly games, including E-Z Bowling,
										Rival Rumble, Pinpix, Angry Birds Bowling, and more, are designed{" "}
									</p>
								</div>
							</div>
						</div>
						<div className={`${styles.luminaries_box}`}>
							<div className={`${styles.luminaries_content}`}>
								...
								<div className={`${styles.desc_box}`}>
									...
									<p className="paraTxt_16 l_h_6 color_white">
										Crown Advantage™, the pioneer in all-inclusive centre operating
										subscriptions. This groundbreaking solution offers a comprehensive
										package that includes cutting-edge Sync software updates and a{" "}
									</p>
								</div>
							</div>
						</div> */}
