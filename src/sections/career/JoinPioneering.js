      ...
      <div className={`${styles.pioneering_main}`}>
        ...
        <div className="container">
          <div className={`${styles.pioneering_content}`}>
            <h2 className="heading_text_55 color_white pb_30">Join The Pioneering Force <br className='hidden-xs'></br> in the Amusement Industry</h2>
            <p className="paraTxt_18 color_white pb_20">Welcome to the CSML family! We're thrilled that you're considering a  career with us. At CSML, 
