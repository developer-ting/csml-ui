    ...
    <section className={`${styles.partner_superior_wrap} ptb_100`}>
      <div className="container">
        <div className={`${styles.section_title} pb_40`}>
          <h2 className="heading_text_55 color_white pb_20">Your partner in superior <br className="hidden-xs" />amusement experience </h2>
          <p className="paraTxt color_white">Discover how CSML can help you achieve entertainment centre success, from concept to operation. Our expertise streamlines planning, design, logistics, staffing, pricing and support.</p>
        </div>
          ...
          <div className={`${styles.partner_superior_box}`}>
            <div className={`${styles.partner_superior_content}`}>
              ...
              <div className={`${styles.desc_box}`}>
                ...
                <p className="paraTxt color_white">Tailored consultancy services for Indoor Amusement Centers (IAC), simplifying operations, ensuring seamless coordination from start to finish.</p>
              </div>
            </div>
          </div>
          <div className={`${styles.partner_superior_box}`}>
            <div className={`${styles.partner_superior_content}`}>
              ...
              <div className={`${styles.desc_box}`}>
                ...
                <p className="paraTxt color_white">Operational excellence is offered via FEC management contract. Our expert team manages day-to-day operations, allowing clients to focus on strategic goals.</p>
              </div>
            </div>
          </div>
        </div>
