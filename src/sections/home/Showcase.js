...
export default function Showcase() {
  ...
  const [progressWidth, setProgressWidth] = useState(0);
	...
	const fillProgress = (currInd) => {
		setProgressWidth((currInd / 5) * 100);
	};
            ...
            <div className={`${styles.showcase_box}`}>
              <div className={`${styles.showcase_content}`}>
                <div className={`${styles.img_box} border_animation`}>
                  ...
                  <div className="dot_two dots_p"></div>
                  <div className="dot_three dots_p"></div>
                  <img className="border_8" src={surat.src} alt="img" />
                </div>
                <div className={`${styles.desc_box}`}>
                  <div className={`${styles.desc_title} f_j`}>
            ...
            <div className={`${styles.showcase_box}`}>
              <div className={`${styles.showcase_content}`}>
                <div className={`${styles.img_box} border_animation`}>
                  ...
                  <div className="dot_two dots_p"></div>
                  <div className="dot_three dots_p"></div>
                  <img className="border_8" src={bengaluru.src} alt="img" />
                </div>
                <div className={`${styles.desc_box}`}>
                  <div className={`${styles.desc_title} f_j`}>
            ...
            <div className={`${styles.showcase_box}`}>
              <div className={`${styles.showcase_content}`}>
                <div className={`${styles.img_box} border_animation`}>
                  ...
                  <div className="dot_two dots_p"></div>
                  <div className="dot_three dots_p"></div>
                  <img className="border_8" src={showcase_two.src} alt="img" />
                </div>
                <div className={`${styles.desc_box}`}>
                  <div className={`${styles.desc_title} f_j`}>
                    <h3 className="text_24 color_white text_400 pb_20">Go Bowl (Bengaluru)</h3>
            ...
            <div className={`${styles.showcase_box}`}>
              <div className={`${styles.showcase_content}`}>
                <div className={`${styles.img_box} border_animation`}>
                  ...
                  <div className="dot_two dots_p"></div>
                  <div className="dot_three dots_p"></div>
                  <img className="border_8" src={showcase_three.src} alt="img" />
                </div>
                <div className={`${styles.desc_box}`}>
                  <div className={`${styles.desc_title} f_j`}>
                    <h3 className="text_24 color_white text_400 pb_20">Go Bowl (Bengaluru)</h3>
